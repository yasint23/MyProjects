...
db_endpoint = open("/home/ubuntu/capstone-tf/src/cblog/dbserver.endpoint", 'r', encoding='UTF-8') 
...
AWS_STORAGE_BUCKET_NAME = 'meleksblog' # please enter your s3 bucket name
